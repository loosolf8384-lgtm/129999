...
local PlayersSection = Window:CreateSection({
    Title = "Игроки"
})
...
local DronesSection = Window:CreateSection({
    Title = "Дроны"
})
...
local WarningSection = Window:CreateSection({
    Title = "Приближение"
})
...
local PerformanceSection = Window:CreateSection({
